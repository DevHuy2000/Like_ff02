...
MASTER_ACCOUNT_ID = '4049479419' #Chỉnh sửa theo tài khoản chính của bạn
                        ...
                        if self.socket_client in readable:
                            ...
                            if '0500' in self.DaTa2.hex()[0:4] and len(self.DaTa2.hex()) > 30:
                                try:
                                    ...
                                    # Nếu Master lưu dữ liệu vào chế độ công khai
                                    ...
                                    # Tự động gửi gói Ghost đến tất cả tài khoản sau khi nhận được 0500
                                        ...
                                        for _ in range(3):
                                            ...
                                            self.socket_client.send(ghost_pakcet(idT, "xnxx.com", sq, key, iv))
                                            time.sleep(0.5)
        ...
        if '/bngx' in command[:5]:
                try:
                        ...
                        # Ghost account logic (uses master info)
                                ...
                                wait_attempts = 0
                                while not shared_0500_info['got'] and wait_attempts < 15:
                                        time.sleep(0.5)
                                        wait_attempts += 1
